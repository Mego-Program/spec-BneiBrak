...
const RichTextEditor = ({stepperData, setStepperData}) => {
    ...
    // const content = '{"blocks":[{"key":"6kdab","text":"Hello  Meir nfdfyj,khl","type":"unstyled","depth":0,"inlineStyleRanges":[{"offset":0,"length":6,"style":"UNDERLINE"},{"offset":5,"length":17,"style":"BOLD"},{"offset":5,"length":2,"style":"ITALIC"}],"entityRanges":[],"data":{}}],"entityMap":{}}'
    const content = stepperData.content
    console.log('content:', content)
    const rawEditorData = JSON.parse(content)
    console.log('rawEditorData:', rawEditorData)
